...
async def main_MemberCounterMeta():
    async with MemberCounterMeta:
        try:
            while True:
                print(text_2)
                edit_message_text_teletips = "**📈 | Rᴇᴀʟ-Tɪᴍᴇ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟs Lɪsᴛ + Mᴇᴍʙᴇʀs Sᴛᴀᴛᴜs 📍** [ˢᵘᵖᵖᵒʳᵗ](https://t.me/dubbedweb)"
                ...
                edit_message_text_teletips += f"\n\n<i>✅ Aᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ʀᴇғʀᴇsʜᴇs ᴇᴠᴇʀʏ 15 ᴍɪɴᴜᴛᴇs ⏰ Pᴏᴡᴇʀᴇᴅ Bʏ ❗ @robo_glitch 👿</i>"
                try:
